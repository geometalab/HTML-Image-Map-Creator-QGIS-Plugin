...
class ImageMapPlugin:
  ...
  def writeHtml(self):
    ...
    if isInfoChecked:
        ...
        html.append(u'function displayBox(centerX, centerY, id) { var infoBox = document.getElementById("info-box"); var infoWidthToCenter = infoBox.offsetWidth / 2; var infoHeight = infoBox.offsetHeight; infoBox.innerHTML = infoBoxes[id]; infoBox.style.left = (centerX - infoWidthToCenter - offsetLeft) + document.body.scrollLeft + "px"; infoBox.style.top = (centerY - infoHeight - 15) + document.body.scrollTop + "px"; } ')
